...
type MetricTypes = INativeMetric | NativeCounter | NativeGauge | NativeHistogram | SingleCounter 
| MultiCounter | SingleGauge | MultiGauge | SingleHistogram | MultiHistogram;
